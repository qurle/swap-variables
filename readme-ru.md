...
-   Если вы изменили внешние библиотеки, обновите вкладку, чтобы изменения применились.
...
-   Плагин не заменяет градиенты и обводки в секциях — этого нет в API. Замените вручную.
